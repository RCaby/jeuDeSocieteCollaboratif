...
public class Strings extends ListResourceBundle {
        ...
        private Object[][] contents = { { "hidden_card_label", "Card !" }, { "not_chief_label", "     " },
                        { "chief_label", "Chief" }, { "AlarmClock_name", "Alarm Clock" },
                        { "AlarmClock_description",
                                        "Allows to choose the player who will play first during the next round" },
                        { "Antivenom_name", "Anti-venom" },
                        { "Antivenom_description", "Cures one player of their snake bite." }, { "Axe_name", "Axe" },
                        ...
                        { "Coconut_description", "Is equivalent to three water rations." }, { "Coffee_name", "Coffee" },
                        ...
                        { "MetalSheet_description", "Protects from one gunshot." }, { "OldBrief_name", "Old Brief" },
                        ...
                        { "Spyglass_name", "Spyglass" }, { "Spyglass_description", "" },
                        ...
                        { "WoodenPlank_description", "Adds one plank on the raft." }, { "player_name", "Player" },
                        { "yesNoQuestion", "(y/n)" }, { "wouldLikePlayCard?", "Would like to play a card ?" },
